...
namespace core {
    ...
    public:
        ...
        virtual void PostDelayedTask(std::unique_ptr<QueuedTask> task, TimeDelta delay) = 0;

        virtual void PostDelayedHighPrecisionTask(std::unique_ptr<QueuedTask> task, TimeDelta delay) = 0;
